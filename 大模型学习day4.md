...
思考步骤为：
![思考过程图](./image/25.12.9day4/leetcode字母异位分词器_思考.jpg)
其中题目要求与代码提交为
![题目要求及代码截图](./image/25.12.9day4/字母异位词分组-代码加题目.png)
2. 最长连续序列
...
思考步骤为：
![思考过程图](./image/25.12.9day4/)
其中题目要求与代码提交为
![题目要求及代码截图](./image/25.12.9day4/最长连续序列-代码加题目.png)
3. 移动0
解题思路，本质上来说是双指针的应用，搞清楚指针指向位置以及即使更新指针即可，将非0数往前移动，将0往后移（测试用例中已经排好序）
思考步骤为：
![思考过程图](./image/25.12.9day4/leetcode最长连续序列，移动0_思考.jpg)
其中题目要求与代码提交为
![题目要求及代码截图](./image/25.12.9day4/移动0-代码加题目.png)
